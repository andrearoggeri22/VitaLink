...
\begin{titlepage}
    ...
    \begin{flushleft}
        ...
        {\fontsize{14}{18} Classe n. L-8 - Ingegneria informatica}
    \end{flushleft}
    ...
    \begin{flushleft}
        ...
        \begin{minipage}[t]{0.47\textwidth}
            ...
            {\fontsize{14}{18}\selectfont\textit{Prof.ssa Silvia Bonfanti}}\\
            \vspace{0.5cm}\\
            {\fontsize{12}{14}\selectfont\textbf{Correlatore:}}\\
            {\fontsize{14}{18}\selectfont\textit{Prof. Angelo Gargantini}}
...
Tutto il materiale relativo al progetto è disponibile pubblicamente sul repository GitHub \url{https://github.com/andrearoggeri22/VitaLink} \cite{github}.
...
Lo sviluppo di VitaLink è stato gestito con Git come sistema di controllo di versione, con un repository ospitato su GitHub \url{https://github.com/andrearoggeri22/VitaLink} \cite{github}.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth,height=0.9\textheight,keepaspectratio]{images/uml/PatientLifecycle.png}
